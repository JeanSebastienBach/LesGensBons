...
\def \fCenter{\ \vdash\ }
    \AxiomC{$$}
            ...
            \UnaryInfC{$\Phi\fCenter\Phi',\Phi$}
            \AxiomC{$$}
            \RightLabel{\scriptsize$ax$}
            \UnaryInfC{$\Phi,\Phi'\fCenter\Phi'$}
            \RightLabel{\scriptsize$\Rightarrow_{g}$}
            \BinaryInfC{$\Phi\Rightarrow \Phi' ,\Phi\fCenter\Phi'$}
            \RightLabel{\scriptsize$\forall_{g}$}
            \UnaryInfC{$(\forall x.\Phi)\Rightarrow \Phi' ,\Phi\fCenter\Phi'$}
            \RightLabel{\scriptsize$\Rightarrow_{d}$}
            \UnaryInfC{$(\forall x.\Phi)\Rightarrow \Phi' \fCenter\Phi\Rightarrow\Phi'$}
            \RightLabel{\scriptsize$\exists_{d}$}
            \UnaryInfC{$(\forall x.\Phi)\Rightarrow \Phi' \fCenter\exists x.\Phi\Rightarrow\Phi'$}
            \RightLabel{\scriptsize$\Rightarrow_{d}$}
            \UnaryInfC{$\fCenter((\forall x.\Phi)\Rightarrow \Phi')\Rightarrow \exists x.\Phi\Rightarrow\Phi'$}
\end{prooftree}
...
\begin{prooftree}
    \AxiomC{$$}
            ...
            \RightLabel{\scriptsize$\exists_{d}$}
            \UnaryInfC{$\Phi \vdash \Phi',\exists x.\Phi$}
            \RightLabel{\scriptsize$\forall_{g}$}
            \UnaryInfC{$\forall x.\Phi \vdash \Phi',\exists x.\Phi$}
            \AxiomC{$$}
            \RightLabel{\scriptsize$ax$}
            \UnaryInfC{$\forall x.\Phi,\Phi'\vdash \Phi'$}
            \RightLabel{\scriptsize$\Rightarrow_{g}$}
            \BinaryInfC{$(\exists x.\Phi \Rightarrow \Phi'),\forall x.\Phi\vdash\Phi'$}
            \RightLabel{\scriptsize$\Rightarrow_{d}$}
            \UnaryInfC{ $(\exists x.\Phi \Rightarrow \Phi') \vdash( \forall x.\Phi )\Rightarrow\Phi'$}
            \RightLabel{\scriptsize$\Rightarrow_{d}$}
            \UnaryInfC{$ \vdash ( \exists x.\Phi \Rightarrow \Phi') \Rightarrow ( \forall x.\Phi ) \Rightarrow \Phi'$}
\end{prooftree}
