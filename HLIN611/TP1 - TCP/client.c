...
int main(int argc, char *argv[]) {
  ...
  m[strlen(m)-1]  = '\0'; // je retire le saut de ligne et le remplace par le symbole fin de chaine                                
...
if (ecoute < sizeof(int)){
    printf("Client : attention, je n'ai reçu qu'uune partie du message attendu; je dois réceptionner le reste\n");
    close (ds);
    exit (1);
  } 
